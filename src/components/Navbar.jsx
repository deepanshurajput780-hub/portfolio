  ...
  return (
    <nav 
      className={`fixed top-0 left-0 w-full z-50 backdrop-blur-xl transition-all duration-300 ${
        isOpen 
          ? 'bg-[#ff2a2a]/95 py-4 shadow-2xl'
          : isScrolled 
            ? 'bg-black/40 py-4 shadow-sm' 
            : 'bg-transparent py-6'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <a href="#" className="text-white text-2xl font-black tracking-tight">
            Deepanshu Yadav<span className="text-red-500">.</span>
          </a>
        </div>
        ...
        <div className="hidden md:block">
          <a
            href="#contact"
            className="inline-flex items-center px-6 py-2.5 rounded-full bg-[#111] text-white font-semibold shadow-lg shadow-black/20 border border-white/10 hover:bg-gray-800 hover:text-white transition-all duration-300"
          >
            Hire Me
          </a>
        </div>
        ...
        <div className="flex flex-col px-6 space-y-4">
          ...
          <div className="pt-4 pb-2">
             <a 
               href="#contact" 
               onClick={() => setIsOpen(false)} 
               className="inline-block px-6 py-3 rounded-full bg-[#111] text-white font-black hover:bg-gray-800 hover:text-white transition-colors w-full text-center shadow-lg"
             >
               Hire Me
             </a>
          </div>
