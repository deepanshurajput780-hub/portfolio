      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Expertise in React.js, Next.js, Node.js, Express.js, MongoDB, REST APIs, and JWT-based authentication. Strong problem solving, debugging, and Agile collaboration skills.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            ...
            text="Architecture and implementation across React, Next.js, Node.js, Express.js, and MongoDB for polished end-to-end products."
          ...
          <TagCard 
            number="02"
            title="API & Auth"
            text="Designing secure RESTful APIs with JWT authentication to protect user sessions and support seamless data workflows."
          ...
          <TagCard 
            ...
            text="Optimizing frontend rendering, responsive layouts, and fast interactions to improve conversion and user retention."
          ...
          <TagCard 
            ...
            text="Working in Agile environments with Git workflows, code review, testing, and transparent delivery rhythms."
